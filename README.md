...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/gibsonfriedman/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/gibsonfriedman/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/gibsonfriedman/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/gibsonfriedman/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/gibsonfriedman/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/gibsonfriedman/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        |  114.172s                 |     78.94s                | 
| `pg_normalized_batch`  |  194.611s                 |     25.58s                | 
| `pg_denormalized`      |  18.108ss                 |     5.94s                 | 
